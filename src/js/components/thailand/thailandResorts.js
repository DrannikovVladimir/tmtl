  ...
  return (
    <ul className="article__resorts resorts">
      <li className="resorts__item">
        <a href="/country/thailand/phuket/index.html" className="resorts__item-link">
          <picture>
        ...
        <div className="resorts__item-content">
          ...
          <a href="/country/thailand/phuket/index.html" className="resorts__item-link resorts__item-link--about">Подробнее о регионе</a>
        </div>
      </li>
      <li className="resorts__item">
        <a href="/country/thailand/pattaya/index.html" className="resorts__item-link">
          <picture>
        ...
        <div className="resorts__item-content">
          ...
          <a href="/country/thailand/pattaya/index.html" className="resorts__item-link resorts__item-link--about">Подробнее о регионе</a>
        </div>
      </li>
      <li className="resorts__item">
        <a href="/country/thailand/samui/index.html" className="resorts__item-link">
          <picture>
        ...
        <div className="resorts__item-content">
          ...
          <a href="/country/thailand/samui/index.html" className="resorts__item-link resorts__item-link--about">Подробнее о регионе</a>
        </div>
      </li>
      <li className="resorts__item">
        <a href="/country/thailand/bangkok/index.html" className="resorts__item-link">
          <picture>
        ...
        <div className="resorts__item-content">
          ...
          <a href="/country/thailand/bangkok/index.html" className="resorts__item-link resorts__item-link--about">Подробнее о регионе</a>
        </div>
      </li>
      <li className="resorts__item">
        <a href="/country/thailand/koh-chang/index.html" className="resorts__item-link">
          <picture>
        ...
        <div className="resorts__item-content">
          ...
          <a href="/country/thailand/koh-chang/index.html" className="resorts__item-link resorts__item-link--about">Подробнее о регионе</a>
        </div>
      </li>
      <li className="resorts__item">
        <a href="/country/thailand/krabi/index.html" className="resorts__item-link">
          <picture>
        ...
        <div className="resorts__item-content">
          ...
          <a href="/country/thailand/krabi/index.html" className="resorts__item-link resorts__item-link--about">Подробнее о регионе</a>
        </div>
      </li>
    </ul>
  )
