    ...
    <>
      ...
      <ul className="article__resorts resorts resorts--list-min">
        <li className="resorts__item resorts__item--list-min">
          <a href="/tours/uae/dubai-resort.html" className="resorts__item-link resorts__item-link--list-min">
            <picture>
        ...
        <li className="resorts__item resorts__item--list-min">
          <a href="/tours/uae/abu-dhabi-resort.html" className="resorts__item-link resorts__item-link--list-min">
            <picture>
        ...
        <li className="resorts__item resorts__item--list-min">
          <a href="/tours/uae/sharjah-resort.html" className="resorts__item-link resorts__item-link--list-min">
            <picture>
        ...
        <li className="resorts__item resorts__item--list-min">
          <a href="/tours/uae/ajman-resort.html" className="resorts__item-link resorts__item-link--list-min">
            <picture>
        ...
        <li className="resorts__item resorts__item--list-min">
          <a href="/tours/uae/fujairah-resort.html" className="resorts__item-link resorts__item-link--list-min">
            <picture>
        ...
        <li className="resorts__item resorts__item--list-min">
          <a href="/tours/uae/ras-al-khaimah-resort.html" className="resorts__item-link resorts__item-link--list-min">
            <picture>
        ...
        <li className="resorts__item resorts__item--list-min">
          <a href="/tours/uae/umm-el-quwain-resort.html" className="resorts__item-link resorts__item-link--list-min">
            <picture>
