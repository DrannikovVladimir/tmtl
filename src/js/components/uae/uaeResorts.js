  ...
  return (
    <ul className="article__resorts resorts">
      <li className="resorts__item">
        <a href="/tours/uae/dubai-resort.html" className="resorts__item-link">
          <picture>
        ...
        <div className="resorts__item-content">
          ...
          <a href="/tours/uae/dubai-resort.html" className="resorts__item-link resorts__item-link--about">Подробнее о регионе</a>
        </div>
      </li>
      <li className="resorts__item">
        <a href="/tours/uae/abu-dhabi-resort.html" className="resorts__item-link">
          <picture>
        ...
        <div className="resorts__item-content">
          ...
          <a href="/tours/uae/abu-dhabi-resort.html" className="resorts__item-link resorts__item-link--about">Подробнее о регионе</a>
        </div>
      </li>
      <li className="resorts__item">
        <a href="/tours/uae/sharjah-resort.html" className="resorts__item-link">
          <picture>
        ...
        <div className="resorts__item-content">
          ...
          <a href="/tours/uae/sharjah-resort.html" className="resorts__item-link resorts__item-link--about">Подробнее о регионе</a>
        </div>
      </li>
      <li className="resorts__item">
        <a href="/tours/uae/ajman-resort.html" className="resorts__item-link">
          <picture>
        ...
        <div className="resorts__item-content">
          ...
          <a href="/tours/uae/ajman-resort.html" className="resorts__item-link resorts__item-link--about">Подробнее о регионе</a>
        </div>
      </li>
      <li className="resorts__item">
        <a href="/tours/uae/fujairah-resort.html" className="resorts__item-link">
          <picture>
        ...
        <div className="resorts__item-content">
          ...
          <a href="/tours/uae/fujairah-resort.html" className="resorts__item-link resorts__item-link--about">Подробнее о регионе</a>
        </div>
      </li>
      <li className="resorts__item">
        <a href="/tours/uae/ras-al-khaimah-resort.html" className="resorts__item-link">
          <picture>
        ...
        <div className="resorts__item-content">
          ...
          <a href="/tours/uae/ras-al-khaimah-resort.html" className="resorts__item-link resorts__item-link--about">Подробнее о регионе</a>
        </div>
      </li>
      <li className="resorts__item">
        <a href="/tours/uae/umm-el-quwain-resort.html" className="resorts__item-link">
          <picture>
        ...
        <div className="resorts__item-content">
          ...
          <a href="/tours/uae/umm-el-quwain-resort.html" className="resorts__item-link resorts__item-link--about">Подробнее о регионе</a>
        </div>
      </li>
    </ul>
  )
