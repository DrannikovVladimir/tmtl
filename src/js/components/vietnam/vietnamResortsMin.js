...
const VietnamResortsMin = () => {
  return (
    <>
      <h2 className="article__title--list-h3">Курорты Вьетнама</h2>
      <ul className="article__resorts resorts resorts--list-min">
        <li className="resorts__item resorts__item--list-min">
          <a href="/country/vietnam/nha-trang/" className="resorts__item-link resorts__item-link--list-min">
            <picture>
        ...
        <li className="resorts__item resorts__item--list-min">
          <a href="/country/vietnam/phan-thiet/" className="resorts__item-link resorts__item-link--list-min">
            <picture>
        ...
        <li className="resorts__item resorts__item--list-min">
          <a href="/country/vietnam/phu-quoc/" className="resorts__item-link resorts__item-link--list-min">
            <picture>
