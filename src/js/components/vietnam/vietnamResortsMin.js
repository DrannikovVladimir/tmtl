    ...
    <>
      ...
      <ul className="article__resorts resorts resorts--list-min">
        <li className="resorts__item resorts__item--list-min">
          <a href="/country/vietnam/nha-trang/index.html" className="resorts__item-link resorts__item-link--list-min">
            <picture>
        ...
        <li className="resorts__item resorts__item--list-min">
          <a href="/country/vietnam/phan-thiet/index.html" className="resorts__item-link resorts__item-link--list-min">
            <picture>
        ...
        <li className="resorts__item resorts__item--list-min">
          <a href="/country/vietnam/phu-quoc/index.html" className="resorts__item-link resorts__item-link--list-min">
            <picture>
