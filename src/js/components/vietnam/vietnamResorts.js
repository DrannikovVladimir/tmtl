  ...
  return (
    <ul className="article__resorts resorts">
      <li className="resorts__item">
        <a href="/country/vietnam/nha-trang/index.html" className="resorts__item-link">
          <picture>
        ...
        <div className="resorts__item-content">
          ...
          <a href="/country/vietnam/nha-trang/index.html" className="resorts__item-link resorts__item-link--about">Подробнее о регионе</a>
        </div>
      </li>
      <li className="resorts__item">
        <a href="/country/vietnam/phan-thiet/index.html" className="resorts__item-link">
          <picture>
        ...
        <div className="resorts__item-content">
          ...
          <a href="/country/vietnam/phan-thiet/index.html" className="resorts__item-link resorts__item-link--about">Подробнее о регионе</a>
        </div>
      </li>
      <li className="resorts__item">
        <a href="/country/vietnam/phu-quoc/index.html" className="resorts__item-link">
          <picture>
        ...
        <div className="resorts__item-content">
          ...
          <a href="/country/vietnam/phu-quoc/index.html" className="resorts__item-link resorts__item-link--about">Подробнее о регионе</a>
        </div>
      </li>
    </ul>
  )
